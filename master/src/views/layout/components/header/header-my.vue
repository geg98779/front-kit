<template>
  <m-popover class="flex items-center">
    <template #reference>
      ...
      >
        <!-- 头像 -->
        <img class="w-3 h-3 rounded-sm" src="@/assets/images/flex.jpg" />
    ...
    <div class="w-[140px] overflow-hidden">
      <div
        class="flex items-ceneter p-1 cursor-pointer rounded hover:bg-zinc-100/60 dark:hover:bg-zinc-800"
